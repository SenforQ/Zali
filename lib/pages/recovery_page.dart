...
class _RecoveryPageState extends State<RecoveryPage> {
  late Future<List<RecoveryPerson>> _peopleFuture;
  ...
  void initState() {
    super.initState();
    _loadFilters();
    _peopleFuture = _loadRecoveryPeople();
  }
  ...
  Future<List<RecoveryPerson>> _loadRecoveryPeople() async {
    final raw = await rootBundle.loadString('assets/Recovery.json');
    final decoded = json.decode(raw) as Map<String, dynamic>;
    final List<dynamic> people = decoded['people'] as List<dynamic>;
    return people
        .map((p) => RecoveryPerson.fromJson(p as Map<String, dynamic>))
        .toList();
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Low-impact sessions focused on mobility, stretching, and breath work.',
              ...
              Expanded(
                child: FutureBuilder<List<RecoveryPerson>>(
  ...
  void _showCardActions(BuildContext context, RecoveryPerson person) {
...
class RecoveryPerson {
  const RecoveryPerson({
    required this.name,
  ...
  factory RecoveryPerson.fromJson(Map<String, dynamic> json) {
