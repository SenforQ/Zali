...
class _StrengthPageState extends State<StrengthPage> {
  late Future<List<StrengthPerson>> _peopleFuture;
  ...
  void initState() {
    super.initState();
    _loadFilters();
    _peopleFuture = _loadStrengthPeople();
  }
  ...
  Future<List<StrengthPerson>> _loadStrengthPeople() async {
    final raw = await rootBundle.loadString('assets/Strength.json');
    final decoded = json.decode(raw) as Map<String, dynamic>;
    final List<dynamic> people = decoded['people'] as List<dynamic>;
    return people
        .map((p) => StrengthPerson.fromJson(p as Map<String, dynamic>))
        .toList();
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Build muscle and power with progressive overload and functional lifts.',
              ...
              Expanded(
                child: FutureBuilder<List<StrengthPerson>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final cover = person.thumbnails.isNotEmpty
                            ? person.thumbnails.first
  ...
  void _showCardActions(BuildContext context, StrengthPerson person) {
...
class StrengthPerson {
  const StrengthPerson({
    required this.name,
  ...
  factory StrengthPerson.fromJson(Map<String, dynamic> json) {
    return StrengthPerson(
