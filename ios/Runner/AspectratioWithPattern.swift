...
class AspectratioWithPattern {
    //: static let shared = AppPermissionTool()
    static let shared = AspectratioWithPattern()

    /// 获取麦克风权限
    //: func requestMicPermission(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
    func bar(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
    ...
    func go(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
        //: if #available(iOS 14, *) {
        if #available(iOS 14, *) {
    ...
    func prompt(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
